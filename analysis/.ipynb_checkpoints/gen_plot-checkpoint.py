...
SB300per  = [92.1030,94.1236,95.2556,29.97,35.8031]

SB300per_SB  = [44.3800,35.8031,43.3315,72.10,32.3447]
...
TED500per  = [31.6240,35.2112,32.0563,42.9468,28.1339]
TED500jsd4_3000 = [0.2927]
TED500per_3000 = [88.7887]

TED10jsd4 = [0.1909,0.2855,0.1928, -1,0,0.1014]
TED10per  = [36.0068,91.2515,33.5211,42.9468,29.13,32.4414]
...
plt.scatter(libri960jsd1 + libri960jsd1_30000+libri960jsd1_3000,libri960per + libri960per_30000+libri960per_3000,color="black")
plt.scatter(libri960jsd2 + libri960jsd2_30000+libri960jsd2_3000,libri960per + libri960per_30000+libri960per_3000,color="orange")
plt.scatter(libri960jsd3 + libri960jsd3_30000+libri960jsd3_3000,libri960per + libri960per_30000+libri960per_3000,color="red")
plt.scatter(libri960jsd4 + libri960jsd4_30000+libri960jsd4_3000,libri960per + libri960per_30000+libri960per_3000,color="blue")
